...
//   late _CustomScrollController _horizontalControllers;
//   List<Drag>? _horizontalDrags;
//   List<ScrollHoldController>? _horizontalHolds;
...
//     if (widget.horizontalController == null) _horizontalControllers.dispose();
...
//   @override
//   void initState() {
//     _horizontalControllers = _CustomScrollController();
...
//     _horizontalControllers.addListener(_handleHorizontalListener);
...
//     final double offset = _horizontalControllers.offset;
//     if (offset + _globalWidth > _tableWidth) {
//       _horizontalControllers.jumpTo(
//         offset.clamp(0, _tableWidth - _globalWidth),
//       );
//     }
//   }
...
//     _horizontalHolds = _horizontalControllers.positions
//         .map((e) => e.hold(() => _horizontalHolds = null))
//         .toList();
//     _verticalHold =
...
//     _horizontalDrags = _horizontalControllers.positions
//         .map((e) => e.drag(details, () => _horizontalDrags = null))
//         .toList();
//     _verticalDrag =
...
//     for (final drag in _horizontalDrags ?? []) {
...
//     _horizontalDrags?.map((e) => e.cancel());
//     _horizontalHolds?.map((e) => e.cancel());
...
//     // Create grid builder
//     Widget _listBuilder(int? rowCount) {
//       final bool hasDecoration = hasBorder;
...
//           physics: NeverScrollableScrollPhysics(parent: widget.physics),
//           itemCount: rowCount,
//           itemExtent: widget.rowHeight + 1,
//           itemBuilder: (_, i) {
//             final List<Widget> children = i == 0
//                 ? _castTableRow(widget.columns, isColumn: true)
//                 : _castTableRow(widget.itemBuilder(i));
...
//               itemBuilder: (__, j) {
//                 return SizedBox(
//                   width: widget.columnWidths?[j],
//                   child: hasDecoration
//                       ? DecoratedBox(decoration: decoration, child: children[j])
//                       : children[j],
//                 );
//               },
//             );
...
//       child: widget.rowsListenable != null
//           ? ValueListenableBuilder<List<T>>(
//               valueListenable: widget.rowsListenable!,
//               builder: (_, value, ___) => _listBuilder(value.length),
//             )
//           : _listBuilder(widget.itemCount),
//     );
...
//   @override
//   ScrollPosition get position => _positions.first;
